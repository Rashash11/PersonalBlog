...
const GITHUB_USER = "Rashash11";

// NOTE: repo URLs are placeholders (github.com/Rashash11/<slug>) — Mostafa's CV
// lists these projects but not their actual repo names. Stars/forks are left at
// 0 rather than fabricated; swap in the real repo names/counts when available.
const PINNED_REPOS = [
  {
    name: "Robotic-Arm-AI-Vision",
    desc: "Autonomous pick-and-place robotic arm achieving 98% accuracy by combining YOLOv8 object detection with the DeepSeek API.",
    stars: 0,
    forks: 0,
    lang: "Python",
    url: "https://github.com/Rashash11/robotic-arm-ai-vision"
  },
  {
    name: "AI-Secure-Chat-Monitor",
    desc: "A Chrome extension that uses AI to monitor chat activity in real time, blocking 90% of potential confidential data leaks.",
    stars: 0,
    forks: 0,
    lang: "JavaScript",
    url: "https://github.com/Rashash11/ai-secure-chat-monitor"
  },
  {
    name: "Restaurant-Recommendation-Engine",
    desc: "A Neural Collaborative Filtering recommendation engine built in PyTorch that increased user engagement by 15%.",
    stars: 0,
    forks: 0,
    lang: "Python",
    url: "https://github.com/Rashash11/restaurant-recommendation-engine"
  },
  {
    name: "AI-Powered-Prosthetic-Hand",
    desc: "Sensor-based Python control system with adaptive AI for personalized prosthetic hand movement, improving responsiveness by 25%.",
    stars: 0,
    forks: 0,
    lang: "Python",
    url: "https://github.com/Rashash11/ai-powered-prosthetic-hand"
  },
  {
    name: "NASA-Space-Apps-Challenge",
    desc: "An AI-enhanced space data visualization platform built for the NASA International Space Apps Challenge, used by 500+ users.",
    stars: 0,
    forks: 0,
    lang: "Python",
    url: "https://github.com/Rashash11/nasa-space-apps-challenge"
  }
];
