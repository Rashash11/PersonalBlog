...
const PROJECT_DATA: ProjectData[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?q=80&w=2070&auto=format&fit=crop&fm=webp",
    category: "Computer Vision & Robotics",
    year: "2024",
    description: "98% pick-and-place accuracy with YOLOv8 + DeepSeek API.",
  ...
  },
  {
    ...
    category: "Security",
    year: "2024",
    description: "Chrome extension blocking 90% of confidential data leaks.",
  ...
  },
  {
    ...
    year: "2025",
    description: "Neural Collaborative Filtering in PyTorch, +15% engagement.",
    slug: "restaurant-recommendation-engine"
  },
  {
    title: "AI-Powered Prosthetic Hand",
    image: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=2070&auto=format&fit=crop&fm=webp",
    category: "AI & Machine Learning",
    year: "2023",
    description: "Sensor-based adaptive AI, +25% movement responsiveness.",
    slug: "ai-powered-prosthetic-hand"
  },
  {
    title: "NASA International Space Apps Challenge",
    image: "https://images.unsplash.com/photo-1614728263952-84ea256f9679?q=80&w=2070&auto=format&fit=crop&fm=webp",
    category: "Data Science",
    year: "2024",
    description: "AI-enhanced space data visualization for 500+ users.",
            ...
            <div className="h-[200px] w-full flex items-center justify-center pt-10">
              ...
              >
                <div className="flex items-center gap-4 pointer-events-auto">
                  <MagneticEffect>
                    <a 
                      href="https://github.com/Rashash11" 
                      target="_blank" 
