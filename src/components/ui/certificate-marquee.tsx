...
// No scanned certificate images available — generic stock photography stands in
// for the parallax gallery texture (same pattern used elsewhere on the site).
const certificates = [
          ...
          <div className="space-y-6 w-full">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-none leading-relaxed lg:whitespace-nowrap">
                A collection of my training and certifications in AI, Data Analysis, and Software Development.
              </p>
            </div>
          </div>
