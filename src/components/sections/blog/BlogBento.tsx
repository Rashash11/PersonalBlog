            ...
            <div className="mx-auto max-w-5xl px-4">
                ...
                >
                    ...
                    <div className="col-span-12 md:col-span-8 grid grid-cols-2 gap-4">
                        ...
                        >
                            <a
                                href={portfolioData.personal.socialLinks.find(s => s.platform === 'Instagram')?.url || "#"}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="grid h-full place-content-center text-2xl text-white"
                            >
                        ...
                        <Block
                            whileHover={{ rotate: "2.5deg", scale: 1.05 }}
                            className="aspect-square bg-gradient-to-br from-indigo-500 to-indigo-700"
                        >
                            <a
                                href={portfolioData.personal.socialLinks.find(s => s.platform === 'Discord')?.url || "#"}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="grid h-full place-content-center text-2xl text-white"
                            >
