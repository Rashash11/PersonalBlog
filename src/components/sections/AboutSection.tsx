...
const showcaseMembers = [
    ...
    ...portfolioData.experiences.filter(exp => exp.id === 'prof-3').map(exp => ({
        ...
        image: "https://images.unsplash.com/photo-1518433278988-c7bc488ce92d?q=80&w=800&auto=format&fit=crop&fm=webp",
        social: exp.externalLink ? { website: Array.isArray(exp.externalLink) ? exp.externalLink[0] : exp.externalLink } : undefined
    })),
    // 4. PMS
    ...portfolioData.experiences.filter(exp => exp.id === 'prof-4').map(exp => ({
        id: exp.id,
        name: exp.company,
        role: exp.position,
        description: exp.description,
...
const GALLERY_IMAGES = [
    "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1509228468518-180dd4864904?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1507413245164-6160d8298b31?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1454165833911-5421db635848?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=800&auto=format&fit=crop&fm=webp",
    "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=800&auto=format&fit=crop&fm=webp"
];
