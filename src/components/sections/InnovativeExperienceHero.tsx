...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'HITU', description: 'B.Sc. in Artificial Intelligence, Helwan International Technological University.', orbitIndex: 0, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'NTI Program', description: 'Huawei & Cisco Collaboration - AI, Data Analysis, Networking Fundamentals.', orbitIndex: 1, position: 0.25, imageUrl: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'ITI Track', description: 'Python, Data Analysis & Cybersecurity at the Information Technology Institute.', orbitIndex: 0, position: 0.42, imageUrl: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Cisco / NTI', description: 'Cisco Python Data Analysis certification.', orbitIndex: 1, position: 0.58, imageUrl: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Deep Learning for NLP', description: 'Applied deep learning training for natural language processing.', orbitIndex: 0, position: 0.72, imageUrl: "https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Java Certification', description: 'Java Development Certification (PMS).', orbitIndex: 1, position: 0.9, imageUrl: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    journey: [
        { label: '98% Vision Accuracy', description: 'Robotic arm pick-and-place accuracy using YOLOv8 + DeepSeek API.', orbitIndex: 0, position: 0.15, imageUrl: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Secure Chat System', description: 'AI system preventing 90% of potential confidential data leaks.', orbitIndex: 1, position: 0.38, imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: '30% Faster Diagnostics', description: 'Python & Bash automation scripts reducing system diagnostic time.', orbitIndex: 0, position: 0.6, imageUrl: "https://images.unsplash.com/photo-1518433278988-c7bc488ce92d?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: '+15% Engagement', description: 'AI-powered restaurant recommendation engine increasing user engagement.', orbitIndex: 1, position: 0.82, imageUrl: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    experience: [
        { label: 'Freelance Developer', description: 'AI, data analysis, and automation solutions for clients since 2023.', orbitIndex: 0, position: 0.2, imageUrl: "https://images.unsplash.com/photo-1454165833911-5421db635848?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Outlier', description: 'AI Data Labeling Specialist - CV/NLP annotation pipelines at 99% accuracy.', orbitIndex: 1, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'GUPCO', description: 'IT & Programming Intern - Python & Bash diagnostic automation.', orbitIndex: 0, position: 0.7, imageUrl: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'PMS', description: 'IT & Programming Intern - automation tools for daily log processing.', orbitIndex: 1, position: 0.92, imageUrl: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ]
};
