    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-4 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* HITU Box (Left) - Hover Effect: Translate Y & Blue Glow */}
                <motion.div 
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500 group-hover:translate-x-1">
                        ...
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">HITU</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            B.Sc. in Artificial Intelligence at Helwan International Technological University, expected 2026. Focused on computer vision, machine learning, and applied AI systems.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center transition-transform duration-500 group-hover:scale-105">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["AI Major", "Computer Vision", "Class of 2026"].map(s => (
                ...
                {/* ITI Box (Right) - Hover Effect: Scale & Orange Glow */}
                <motion.div 
                    initial={isLowPowerMode ? {} : { opacity: 0, y: 20 }}
                    whileInView={isLowPowerMode ? {} : { opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="text-xs font-bold uppercase tracking-widest text-neutral-500 dark:text-neutral-400 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">Certification • Training</span>
                        </div>
                        <h3 className="text-3xl font-black text-neutral-900 dark:text-white mb-4">ITI</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            Information Technology Institute track covering Python, Data Analysis, and Cybersecurity, strengthening core software engineering foundations.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <div className="flex flex-wrap gap-2 justify-center mb-4">
                                {["Python", "Data Analysis", "Cybersecurity"].map(s => (
