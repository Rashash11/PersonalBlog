...
// No scanned certificate images available — pool holds (label, generic stock photo) pairs.
const CERTIFICATE_POOL: { label: string; src: string }[] = [
    { label: "Huawei & Cisco Collaboration (NTI)", src: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=800&auto=format&fit=crop&fm=webp" },
    { label: "Python, Data Analysis & Cybersecurity (ITI)", src: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=800&auto=format&fit=crop&fm=webp" },
    { label: "Cisco Python Data Analysis", src: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=800&auto=format&fit=crop&fm=webp" },
    { label: "Deep Learning for NLP", src: "https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=800&auto=format&fit=crop&fm=webp" },
    { label: "Python Development (ITI)", src: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=800&auto=format&fit=crop&fm=webp" },
    { label: "Java Development Certification (PMS)", src: "https://images.unsplash.com/photo-1509228468518-180dd4864904?q=80&w=800&auto=format&fit=crop&fm=webp" },
];
...
const CertificateHeroScroll: FC<CertificateHeroScrollProps> = ({ onDownloadClick, isLowPowerMode: isLowPowerModeProp }) => {
    ...
    const createCertItem = useCallback((cert: { label: string; src: string }): ImageItem => ({
        id: cert.label.replace(/\s+/g, '-').toLowerCase(),
        src: cert.src,
        alt: cert.label,
        isPdf: false
    }), []);
