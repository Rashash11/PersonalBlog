...
const highlightContent = {
    education: {
        ...
        description: "Every line of code starts with understanding. My academic journey studying Artificial Intelligence shapes how I approach complex problems with systematic thinking."
    },
    journey: {
...
function ExperienceTabSlider({ isLowPowerMode }: { isLowPowerMode: boolean }) {
    ...
    const tabs: TabItem[] = [
        { id: 'education', label: 'Education', description: 'Building strong foundations through academic excellence at Helwan International Technological University.' },
        ...
        content: (
            <div className="space-y-12">
                {group.experiences.map((exp) => {
                    ...
                    // No experience entries currently carry a `logo` — these checks are
                    // dormant until logo assets are added back for a specific employer.
